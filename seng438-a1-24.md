...
The objective of this lab is to obtain hands-on experience with testing methodologies in a software system, including exploratory testing, manual scripted testing, and regression testing. Prior to the lab, we were introduced to these different kinds of testing procedures, and the rationale behind them. Exploratory testing is a type of testing where the tester actively explores the application to find defects without following a specific test script. It is an unscripted, informal testing method that is typically used early in the development process when requirements are not well understood. Manual scripted testing, on the other hand, is a type of testing where the tester follows a specific test script that is created in advance. This method is typically used later in the development process when requirements are well understood. Regression testing is a type of testing that is used to ensure that changes to the application or system do not introduce new defects or break existing functionality. This type of testing is typically done after changes have been made to the application or system, and it is used to verify that the changes did not negatively impact the rest of the application or system. Using a combination of these methodologies, we were able to visualize the distinct purposes of each, and further understand their unique advantages and disadvantages.
